...
//! This file is part of the Winterfell library.
//// It implements the Merkle path verification AIR, which is used to verify Merkle proofs
//its purpose is to ensure that a given Merkle path resolves to the correct tree root.
//its not my orignal work, but a modified version of the original Merkle AIR implementation
//from the Winterfell library.
